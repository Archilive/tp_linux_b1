...
Ici la gateway dans le réseau d'Ynov sert à avoir accès à Internet
```
...
```
PS C:\Users\Victor>  ping 192.168.0.1
...
```
S C:\Users\victor\Dropbox\PC\Downloads\netcat-win32-1.11\netcat-1.11> .\nc.exe -l -p 8888
```
...
```
PS C:\Users\Victor> ipconfig -all
...
```
PS C:\Users\Victor> nslookup 78.74.21.21
Serveur :   dns.google
Address:  8.8.8.8
...
```
PS C:\Users\Victor> nslookup 92.146.54.88
Serveur :   dns.google
Address:  8.8.8.8
